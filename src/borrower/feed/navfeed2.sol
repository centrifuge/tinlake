...
contract NAVFeed2 is BaseNFTFeed, Interest, FixedPoint {
    ...
    function currentNAV() public view returns(uint) {
        ...
        uint nav_ = rmul(approximatedNAV, rpow(discountRate.value,
            safeSub(nnow, nLastUpdate), ONE));
