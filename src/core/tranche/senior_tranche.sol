...
contract SeniorTranche is Tranche {
    ...
    uint public chi;           // accumulated interest over time
    ...
    uint public pie;    // denominated as debt/chi. denominated in RAD (10^27)
    ...
    function toPie(uint amount) public returns(uint) {
