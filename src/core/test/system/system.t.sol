...
//        borrower.doApprovecollateralNFT(collateralNFT, address(deployer.shelf()));
//
//        // borrow transaction
...
//        return currency.balanceOf(address(deployer.distributor()));
//    }
//
...
//        borrower.doApproveCurrency(address(deployer.shelf()), uint(-1));
//
//        uint distributorBalance = currency.balanceOf(address(deployer.distributor()));
//        for (uint i = 1; i <= 10; i++) {
//            principal = i * 80;
//
//            // repay transaction
