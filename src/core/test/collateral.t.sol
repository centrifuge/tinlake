/// collateral.t.sol -- test for erc20.sol
...
contract TokenUser {
    ...
    constructor(Collateral token_) public {
        token = token_;
    }
...
contract CollateralTest is DSTest {
    ...
    function createToken() internal returns (Collateral) {
        return new Collateral("$","TST", "1", 1);
    }
